...
const footerLinks: Record<string, FooterLink[]> = {
  ...
  Solutions: [
    ...
    { href: '/for-bim-managers',             label: 'For BIM Managers' },
    { href: '/for-sustainability-experts',   label: 'For Sustainability Experts' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6 group w-fit">
              <div className="flex items-center justify-center w-9 h-9 rounded-full bg-sandstone-400 text-white text-xs font-bold tracking-widest">H</div>
              <div>
                <div className="font-serif font-bold text-white text-base leading-none">Hestia Smart Interiors</div>
                <div className="text-[10px] font-semibold tracking-[0.16em] uppercase text-sandstone-400 mt-0.5">Powered by HSIOS™</div>
              </div>
            </Link>
            ...
            <div className="space-y-3 mb-8">
              ...
              >
                ...
                <span className="text-sm text-warmgray-300 group-hover/link:text-white transition-colors">+91-8010234802</span>
              </a>
              <a href="mailto:hello@hsios.in" className="flex items-center gap-3 group/link">
                <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/5 group-hover/link:bg-white/10 transition-colors">
                ...
                <span className="text-sm text-warmgray-300 group-hover/link:text-white transition-colors">hello@hsios.in</span>
              </a>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/hestiavillas"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/5 hover:bg-white/12 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-sandstone-400">
              ...
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/5 hover:bg-white/12 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-sandstone-400">
      ...
      <div className="border-t border-white/8">
        <div className="container-luxury py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="text-xs text-warmgray-500 hover:text-warmgray-300 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-xs text-warmgray-500 hover:text-warmgray-300 transition-colors">
              Terms of Service
            </Link>
            <span className="text-xs text-warmgray-600">Made in India</span>
          </div>
        </div>
      </div>
    </footer>
